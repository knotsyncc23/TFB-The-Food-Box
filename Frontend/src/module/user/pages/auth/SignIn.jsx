            ...
            <div className="flex justify-center items-center gap-6 mt-4">
              ...
              <div className="relative group">
                <button
                  ...
                  className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-black flex items-center justify-center hover:bg-gray-900 transition-all active:scale-95 shadow-sm"
              ...
              <button
                ...
                className="w-12 h-12 md:w-14 md:h-14 rounded-full border border-gray-300 dark:border-gray-700 flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-800 transition-all hover:shadow-md active:scale-95 shadow-sm"
              ...
              <button
                ...
                className="w-12 h-12 md:w-14 md:h-14 rounded-full border border-[#671E1F] flex items-center justify-center hover:opacity-90 transition-all hover:shadow-md active:scale-95 bg-[#671E1F] shadow-sm"
