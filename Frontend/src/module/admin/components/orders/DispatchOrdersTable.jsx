              ...
              >
                {visibleColumns.sl && (
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm font-medium text-slate-700">{order.sl || (effectivePage - 1) * itemsPerPage + index + 1}</span>
                  </td>
                )}
                {visibleColumns.order && (
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    {order.paymentStatus && (
                      <div className={`text-xs mt-0.5 ${
                        order.paymentStatus === "Paid" ? "text-red-600" : "text-red-600"
                      }`}>
                        {order.paymentStatus}
                      </div>
                    )}
