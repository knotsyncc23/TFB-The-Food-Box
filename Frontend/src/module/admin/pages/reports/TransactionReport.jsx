          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg shadow-sm border border-slate-200 p-4" style={{ backgroundColor: '#f1f5f9' }}>
              ...
              <div className="text-center">
                <p className="text-xl font-bold text-red-600 mb-1">{formatCurrency(summary.completedTransaction)}</p>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg shadow-sm border border-slate-200 p-3" style={{ backgroundColor: '#f1f5f9' }}>
              <div className="flex items-center justify-between">
                ...
                <p className="text-base font-bold text-red-600">{formatCurrency(summary.restaurantEarning)}</p>
              </div>
            </div>
                ...
                {filteredTransactions.length === 0 ? (
                  ...
                  filteredTransactions.map((transaction, index) => (
                    ...
                    >
                      ...
                      <td className="px-1.5 py-1">
                        <span className="text-[10px] font-medium text-slate-900">{formatFullCurrency(transaction.orderAmount ?? transaction.totalAmount)}</span>
                      </td>
                    </tr>
                  ))
                )}
