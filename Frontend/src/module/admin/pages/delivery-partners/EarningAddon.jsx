    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2.5 text-sm font-medium rounded-lg bg-red-500 text-white hover:bg-red-600 flex items-center gap-2 transition-all"
              >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl bg-gradient-to-br from-slate-50 via-white to-slate-50 p-0 border-0 shadow-2xl">
          <div className="bg-gradient-to-r from-red-500 to-red-600 px-5 py-4 rounded-t-2xl">
          ...
          <form onSubmit={handleSubmit} className="px-5 py-5 space-y-4">
            ...
            <DialogFooter className="pt-3 border-t border-slate-200 mt-4">
              ...
              <button
                type="submit"
                className="px-5 py-2 text-sm font-semibold rounded-lg bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 shadow-md shadow-red-500/30 transition-all"
              >
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
              ...
              <button
                ...
                className="px-5 py-2.5 text-sm font-semibold rounded-xl bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 shadow-lg shadow-red-500/30 transition-all"
              >
                Apply
              </button>
            </div>
